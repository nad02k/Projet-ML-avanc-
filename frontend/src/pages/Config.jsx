...
export default function Config({ selectedIds }) {
    ...
    useEffect(() => { setParams(buildDefaults(algo)); }, [activeModel]);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="glass-card p-7">
                        ...
                        {/* Description */}
                        <div className="p-4 rounded-xl mb-5 text-sm leading-relaxed" style={{ background: '#fffbeb', border: '1px solid #fde68a', color: '#92400e' }}>
